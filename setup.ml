...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9b99358ae0678f5c37ec1a3769e4f519) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_aewo", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "aewo.ml"});
               Executable
                 ({
                     cs_name = "test_aewo";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_aewo.ml"});
               Test
                 ({
                     cs_name = "test_aewo";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "test_aewo"]
                   })
            ];
     ...
     oasis_digest = Some "m\023\n\2557\143\193\183\232\251b\"s\0000W";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
